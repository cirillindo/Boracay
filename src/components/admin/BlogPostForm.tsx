  ...
  const onSubmit = async (data: BlogPost) => {
    ...
    try {
      ...
      const postData = {
        ...
        og_url: data.og_url || `${window.location.origin}/blog/${slug}`,
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500"
                  placeholder="https://www.boracay.house/blog/your-post"
                />
                <p className="mt-1 text-sm text-gray-500">
              ...
              <div className="border border-gray-200 rounded-lg p-4 bg-white">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-[#006621] text-sm">
                    {window.location.origin}/blog/{watch('title')?.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '') || 'post-url'}
                  </div>
