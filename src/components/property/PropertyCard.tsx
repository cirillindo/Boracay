...
const formatNightlyRate = (min?: number, max?: number, currency = 'EUR') => {
  ...
  return `${formatPrice(min, currency)} - ${formatPrice(max, currency)}/night`;
};
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-lg font-bold text-gray-900">
            {showNightlyRate 
              ? formatNightlyRate(property.nightly_rate_min, property.nightly_rate_max, property.selectedCurrency)
              : formatPrice(property.price, property.selectedCurrency)
            }
          </span>
        </div>
