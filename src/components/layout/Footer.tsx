    ...
    >
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-4">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4 text-gray-400 max-w-md">
              We're not agents — just island homeowners sharing our villas, homes, and local experience with future buyers and guests.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/airbnb" className="text-gray-400 hover:text-white transition-colors">Airbnb</Link></li>
        ...
        <div className="border-t border-gray-800 py-2 text-center text-gray-500">
          <p>© {currentYear} Boracay.House. All rights reserved.</p>
        </div>
      </Container>
    </footer>
  );
