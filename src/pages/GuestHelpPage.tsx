...
const GuestHelpPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Guest Help & Support | Boracay.house - Your Stay Made Easy</title>
        <meta name="description" content="Complete guest support for your Boracay stay. Emergency contacts, housekeeping, maintenance, and local services - all in one place." />
        <link rel="canonical" href="https://www.boracay.house/guest-help" />
      </Helmet>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium">WhatsApp: +63 969 331 6725 – Norland</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600">Luggage storage is available before check-in and after check-out — please coordinate in advance with Norland via WhatsApp: +63 969 331 6725</p>
                    <a
